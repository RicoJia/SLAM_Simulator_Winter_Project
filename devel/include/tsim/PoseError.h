...
struct PoseError_
{
  ...
  (void)_alloc;
   ...
   typedef double _x_error_type;
  _x_error_type x_error;

   typedef double _y_error_type;
  _y_error_type y_error;

   typedef double _theta_error_type;
...
struct MD5Sum< ::tsim::PoseError_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x206b7def6dfb0bd5ULL;
  static const uint64_t static_value2 = 0xe66edf944c1bb4dcULL;
};
...
struct Definition< ::tsim::PoseError_<ContainerAllocator> >
{
  static const char* value()
  {
    return "float64 x_error #absolute value of the x error\n"
...
struct Printer< ::tsim::PoseError_<ContainerAllocator> >
{
  ...
  {
    s << indent << "x_error: ";
    Printer<double>::stream(s, indent + "  ", v.x_error);
    s << indent << "y_error: ";
    Printer<double>::stream(s, indent + "  ", v.y_error);
    s << indent << "theta_error: ";
    Printer<double>::stream(s, indent + "  ", v.theta_error);
  }
};
